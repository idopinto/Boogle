...
class BoggleController:
    ...
    def __init__(self):
        ...
        reset = Button(self._gui.frames["Board"].reset_and_check, text="Reset", **LETTER_STYLE,
                       command=self.reset)  # creates the reset button.
        check = Button(self._gui.frames["Board"].reset_and_check, text="Check", **LETTER_STYLE,
